...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{Figures/FS1-iid-splitting-non-overlapping.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{Figures/FS3-iid-splitting-non-overlapping.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{Figures/FS1-subjective-splitting-non-overlapping.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{Figures/FS2-subjective-splitting-non-overlapping.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{Figures/FS3-subjective-splitting-non-overlapping.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{Figures/FS1-subjective-splitting-overlapping.png}
